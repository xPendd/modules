...
global.dfail = (type, m, conn) => {
    ...
    let msgg = {
    	unreg: '*ʜᴀʟᴏʜᴀ ❤‍🔥, ᴀɴᴅᴀ ʙᴇʟᴜᴍ ᴛᴇʀᴅᴀғᴛᴀʀ ᴅɪ ᴅᴀᴛᴀʙᴀsᴇ ᴋᴀᴍɪ ᴊᴀᴅɪ ᴍᴏʜᴏɴ ᴜɴᴛᴜᴋ ᴠᴇʀɪғ ᴛᴇʀʟᴇʙɪʜ ᴅᴀʜᴜʟᴜ, ᴛᴀᴘɪ sᴇʙᴇʟᴜᴍ ɪᴛᴜ sɪʟᴀʜᴋᴀɴ ʙᴀᴄᴀ ʙᴇʙᴇʀᴀᴘᴀ ʀᴜʟᴇs ʙᴇʀɪᴋᴜᴛ,'
}[type]
if (msgg) return conn.sendButton(m.chat, `${global.htki} INFORMASI ${global.htka}`, msgg, null, ['= 𝙍𝙪𝙡𝙚𝙨 =', '/akumauo'],m)
}
